...
import { ShoppingCart, Flame, Heart, Menu, Truck, CreditCard, RefreshCw, ArrowLeft, Plus, X, Minus, Check, Search, ChevronDown, User, Home, Grid, Send } from "lucide-react";
...
export default function StreetWearShop() {
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-white pb-24 md:pb-0">
      ...
      <section ref={footerRef} className="py-24 bg-black overflow-hidden relative border-t border-white/5">
        <div className="absolute inset-0 opacity-20 pointer-events-none">
          <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_50%_50%,#f59e0b22,transparent_70%)]" />
          <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')] opacity-30" />
        </div>
        
        <div className="max-w-5xl mx-auto px-6 relative z-10">
          <div className="flex flex-col md:flex-row items-stretch gap-0 border-2 border-white/10 bg-neutral-900 shadow-[20px_20px_0px_0px_rgba(245,158,11,0.1)]">
            <div className="flex-1 p-8 md:p-12 border-b-2 md:border-b-0 md:border-r-2 border-white/10 relative overflow-hidden group">
              ...
              <p className="text-neutral-400 text-sm md:text-base font-bold uppercase tracking-tight max-w-md leading-relaxed">
                Лимитированные дропы, секретные промокоды и бэкстейдж съемок. Стань частью семьи SHADOWSTREET.
              </p>
            </div>
            ...
            <div className="w-full md:w-[320px] p-8 md:p-12 flex flex-col justify-center bg-neutral-800/50 backdrop-blur-md">
              <div className="mb-8">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-white font-black uppercase tracking-tighter">Telegram</div>
                    <div className="text-[10px] text-amber-500 font-black">@shadow_street_ru</div>
                  </div>
                </div>
              </div>
