...
const products = [
  {
    ...
    description: "Премиальный хлопок, идеальны для классических туфель",
    price: 1890,
    oldPrice: 2490,
    image: giftBoxImg,
    tag: "Best Seller",
  ...
  },
  {
    ...
    description: "7 пар для каждого дня недели, усиленная пятка",
    price: 2990,
    image: businessImg,
    tag: "Premium",
    category: "Наборы",
  },
  {
    id: 3,
    name: "«No Limits»",
    description: "Дерзкий принт для тех, кто не боится выделяться",
    price: 690,
    image: noveltyImg,
    tag: "Trending",
  ...
  },
  {
    id: 4,
    name: "«The Boss»",
    description: "Для тех, кто принимает решения в любой ситуации",
    price: 750,
    oldPrice: 990,
    image: noveltyImg,
    tag: "SALE",
  ...
  },
  {
    ...
    description: "Анатомическая поддержка и отвод влаги",
    price: 990,
    image: athleticImg,
    tag: "PRO",
    category: "Спорт",
  },
  {
    id: 6,
    name: "Winter Thermo",
    description: "Шерсть мериноса для самых низких температур",
    price: 1290,
    image: athleticImg,
    tag: "Winter",
    category: "Спорт",
  },
  {
    id: 7,
    name: "Набор «Infinity»",
    description: "Яркие геометрические узоры для творческих людей",
    price: 1990,
    image: colorfulImg,
    tag: "Gift Choice",
    category: "Наборы",
  },
  {
    id: 8,
    name: "«Super Power»",
    description: "Твоя секретная энергия в каждом шаге",
    price: 590,
    image: noveltyImg,
    category: "С надписями",
  },
...
const reviews = [
  { id: 1, name: "Александр В.", text: "Качество на высоте! После 10 стирок как новые.", rating: 5 },
  { id: 2, name: "Мария П.", text: "Брала мужу в подарок набор «Gentleman», он в восторге от упаковки!", rating: 5 },
  { id: 3, name: "Дмитрий К.", text: "Спортивные носки реально работают, ноги не устают.", rating: 4 },
];
