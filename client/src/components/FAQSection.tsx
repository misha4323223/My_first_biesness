          ...
          {faqs.map((faq, index) => (
            ...
            >
              <Card className="p-0 overflow-hidden border border-white/[0.03] bg-white/[0.01] hover:bg-white/[0.03] backdrop-blur-md transition-all duration-300 rounded-lg no-default-hover-elevate">
                ...
                >
                  <span className="font-medium text-xs md:text-sm text-foreground/80 group-hover:text-foreground transition-colors leading-snug pr-4 flex-1 whitespace-normal break-words">
                    {faq.question}
                  </span>
