...
Мы занимаемся: разработкой инновационных сайтов, созданием уникального дизайна, интеграцией нейросетей и автоматизацией бизнес-процессов.
Стиль: деловой, но доступный, экспертный, без избитых клише и лишних восклицательных знаков. 
Обязательно используй хэштеги в конце поста (например: #MPWebStudio #ВебРазработка #WebDesign #Нейросети #AI #Инновации).`;

        const userPrompt = `Придумай и напиши новый актуальный пост. Выбери одну из тем: 
1. Как нейросети меняют бизнес в 2026 году.
2. Почему старый сайт тянет продажи вниз.
3. Преимущества разработки сайтов в MP.WebStudio.
4. Тренды веб-дизайна и UX/UI.
5. Интеграция искусственного интеллекта в бизнес-процессы.
